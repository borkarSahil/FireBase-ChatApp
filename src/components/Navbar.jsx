  ...
  return (
    <>
      <header
        ...
        className="text-gray-600 body-font shadow p-0 mb-10 "
      >
        <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <div className="m-0 p-0">
              <img
                src="/public/images/Removal-349.png"
                alt=""
                className="mx-auto w-full h-14"
              />
            </div>
          </a>
          <nav className="pr-10 md:ml-auto flex flex-wrap items-center text-base justify-center">
            <div className="p-1">
              <img
            ...
            <div className=" p-1">
              <h3 className="text-zinc-900">{currentUser.displayName}</h3>
            </div>
          </nav>
          <button
            onClick={logOut}
            className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-full px-4 py-2"
          >
            LogOut
          </button>
        </div>
...
//     <a classname="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
//       <span classname="ml-3 text-xl">ChatApp</span>
//     </a>
